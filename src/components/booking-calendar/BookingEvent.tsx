...
export function BookingEvent({ booking, staffIndex, startHour, durationHours = 1, onEditBlock, onCancelBlock }: BookingEventProps) {
  ...
  const height = calculatedDuration * 64;
