  ...
  return (
    <div className="space-y-5 text-sm leading-relaxed">
      ...
      <div className="space-y-2">
        ...
        <p>The Contractor agrees to provide dog grooming services to the Company on a self-employed basis.</p>
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <p>The Contractor shall perform dog grooming services as agreed upon between the parties. Any changes to the scope of work must be agreed upon in writing by both parties.</p>
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <p>The Contractor acknowledges and agrees that they are responsible for the payment of their own taxes and National Insurance contributions. The Company shall provide appropriate insurance coverage.</p>
      </div>
      <div className="space-y-2">
        <h3 className="font-heading font-semibold">6. Confidentiality</h3>
        <p>The Contractor shall maintain the confidentiality of any proprietary or confidential information belonging to the Company and shall not disclose such information to any third party.</p>
      </div>
      <div className="space-y-2">
        <h3 className="font-heading font-semibold">7. Intellectual Property</h3>
        <p>Any intellectual property created by the Contractor in the course of providing the dog grooming services shall belong to the Company.</p>
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <p>The Contractor acknowledges and agrees that they are an independent contractor and not an employee of the Company. The Contractor shall not be entitled to any benefits provided to employees of the Company.</p>
      </div>
      <div className="space-y-2">
        <h3 className="font-heading font-semibold">10. Health and Safety</h3>
