...
import type { Highlights } from "./useYoYAnalytics";
...
export default function HighlightsSidebar({ highlights, selectedMonthName }: Props) {
  ...
  return (
    <div className="rounded-[20px] p-5 space-y-4 h-fit" style={{ backgroundColor: "#2D1B0E" }}>
      ...
      {vsLastYear && (
        <div>
          <p className="text-[10px] text-white/50 uppercase tracking-widest font-semibold">📊 vs Last Year ({selectedMonthName})</p>
